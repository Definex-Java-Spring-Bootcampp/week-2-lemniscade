...
public class User {
   ...
   // private LocalDate birthDate;
    ...
    public static List<Application> concatenatedList;
    public User() {
    }
...
*/
    ...
    public void concatApplicationList(List<Application> application) {
    	//concatenatedList.addAll(application);
    	concatenatedList=Stream.of(application)
        .flatMap(List::stream)
